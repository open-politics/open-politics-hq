...
class InfospaceService:
    ...
    async def export_infospace(
        ...
        from app.api.modules.sharing.services.package_service import PackageBuilder, PackageMetadata, DataPackage
    ...
    async def import_infospace(
        ...
        from app.api.modules.sharing.services.package_service import DataPackage, PackageMetadata, PackageImporter
