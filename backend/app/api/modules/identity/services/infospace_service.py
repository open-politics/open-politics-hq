...
# Package-related classes imported lazily in export/import methods to avoid circular import
from app.api.content.services.asset_service import AssetService

# Moved ShareableService import under TYPE_CHECKING
if TYPE_CHECKING:
    from app.api.sharing.services.shareable_service import ShareableService
...
class InfospaceService:
    ...
    async def export_infospace(
        ...
        from app.api.sharing.services.package_service import PackageBuilder, PackageMetadata, DataPackage
    ...
    async def import_infospace(
        ...
        from app.api.sharing.services.package_service import DataPackage, PackageMetadata, PackageImporter
