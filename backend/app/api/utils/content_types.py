...
from typing import FrozenSet, List, Optional, Set, Type, TypeVar
...
from app.api.processors.base import BaseProcessor, ProcessingContext
...
class ContentTypeRegistry:
    ...
    def _register_builtin(self) -> None:
        ...
        from app.api.processors.csv_processor import CSVProcessor
        from app.api.processors.excel_processor import ExcelProcessor
        from app.api.processors.pdf_processor import PDFProcessor
        from app.api.processors.web_processor import WebProcessor
