...
class UnifiedProviderRegistry:
    ...
    def _setup_providers(self):
        ...
        self._providers["ollama"] = ProviderMetadata(
            ...
            name="Ollama",
            capability=ProviderCapability.LLM,
            description="Open-source local LLM runtime. Run models privately on your infrastructure",
        ...
        self._providers["ollama_embeddings"] = ProviderMetadata(
            ...
            description="Open-source local embeddings via Ollama. Run privately on your infrastructure",
            requires_api_key=False,
            enabled=True,
            is_local=True,
            is_oss=True,  # Open source
