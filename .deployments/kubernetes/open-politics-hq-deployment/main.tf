...
resource "hcloud_network" "private_network" {
  name     = "open-politics-${var.cluster_slug}-prod-network"
  ip_range = "10.0.0.0/16"
  
  labels = {
    project = "open-politics"
...
resource "hcloud_firewall" "k8s_firewall" {
  name = "open-politics-${var.cluster_slug}-prod-firewall"
...
resource "hcloud_server" "master_node" {
  name        = "open-politics-${var.cluster_slug}-prod-master"
  image       = "ubuntu-24.04"
...
resource "hcloud_server" "worker_nodes" {
  ...
  name        = "open-politics-${var.cluster_slug}-prod-worker-${count.index + 1}"
  image       = "ubuntu-24.04"
