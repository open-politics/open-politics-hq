...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-2 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-hidden group-data-[collapsible=icon]:overflow-hidden overflow-y-auto scrollbar-hide",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50  data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      ...
      colorVariant: {
        default: "",
        blue: "[&>svg]:text-blue-700 dark:[&>svg]:text-blue-400",
        teal: "[&>svg]:text-teal-700 dark:[&>svg]:text-teal-400", 
        pink: "[&>svg]:text-pink-700 dark:[&>svg]:text-pink-400",
        green: "[&>svg]:text-green-700 dark:[&>svg]:text-green-400",
        sky: "[&>svg]:text-sky-700 dark:[&>svg]:text-sky-400",
        gray: "[&>svg]:text-slate-700 dark:[&>svg]:text-slate-400",
      },
    },
    defaultVariants: {
      variant: "default",
...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    ...
    colorVariant?: "default" | "blue" | "teal" | "pink" | "green" | "sky" | "gray"
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size, colorVariant }), className)}
        {...props}
      />
    )
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 [@media(pointer:coarse)]:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground md:opacity-0",
        className
      )}
      {...props}
    />
