 ...
 */
// Canonical home is `@/lib/format`; re-exported here so chat toolcall consumers
// keep importing from `toolcalls/shared/utils` unchanged.
export { resolveMarkdownUrls, formatPercentage } from '@/lib/format';
...
// `formatPercentage` is re-exported from `@/lib/format` at the top of this file.
