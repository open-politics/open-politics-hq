// frontend/src/components/collection/workspaces/documents/DocumentDetailViewTextBlock.tsx
...
interface DocumentDetailViewTextBlockProps {
  dataSource: ClientDataSourceRead;
  associatedRecords: DataRecordRead[]; // Should contain the single record for the text block
...
const DocumentDetailViewTextBlock: React.FC<DocumentDetailViewTextBlockProps> = ({
  dataSource,
  associatedRecords,
  isLoadingRecords,
  renderEditableField,
...
export default DocumentDetailViewTextBlock;
