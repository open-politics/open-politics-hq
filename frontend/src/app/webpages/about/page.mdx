...
What began as tooling for research needs became general purpose infrastructure. Almost by accident, we'd built something that serves any field where you need to extract meaning from unstructured information.
