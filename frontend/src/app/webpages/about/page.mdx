...
## Jump into Open Politics
Check out our documentation [here](#https://docs.open-politics.org) to understand where to start and how we do what we do. 
...
Fastest way to reach us: [Mail us](#mailto:engage@open-politics.org)
