    ...
    <div className="p-6 max-h-full rounded-lg overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="group">
            <Link href="/hq/chat" className="block">
              <Card className="group-hover:shadow-md group-hover:border-teal-300 dark:group-hover:border-teal-500 transition-all duration-200 cursor-pointer">
          ...
          <div className="group">
            <Link href="/hq/infospaces/annotation-runner" className="block">
              <Card className="group-hover:shadow-md group-hover:border-blue-300 dark:group-hover:border-blue-500 transition-all duration-200 cursor-pointer">
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="group">
            <Link href="/hq/infospaces/asset-manager" className="block">
              <Card className="group-hover:shadow-md group-hover:border-green-300 dark:group-hover:border-green-500 transition-all duration-200 cursor-pointer">
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
          ...
          <div className="group">
            <Link href="/hq/infospaces/annotation-schemes" className="block">
              <Card className="group-hover:shadow-md group-hover:border-sky-300 dark:group-hover:border-sky-500 transition-all duration-200 cursor-pointer">
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="group">
            <Card className="group-hover:shadow-md group-hover:border-gray-400 dark:group-hover:border-gray-500 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
          ...
          <div className="group">
            <Card className="group-hover:shadow-md group-hover:border-slate-400 dark:group-hover:border-slate-500 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="p-1.5 rounded-md bg-slate-500/15 dark:bg-slate-500/20 text-slate-700 dark:text-slate-400">
