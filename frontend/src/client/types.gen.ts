...
export type GenerateFormulaFromPromptData = {
    infospaceId: number;
    packageToken?: (string | null);
    requestBody: GenerateFormulaRequest;
    runId: number;
    xPackageToken?: (string | null);
};

export type GenerateFormulaFromPromptResponse = (Formula);
