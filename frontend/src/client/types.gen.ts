...
export type CreateRssSource1Data = {
    infospaceId: number;
    requestBody: RssSourceCreateRequest;
};

export type CreateRssSource1Response = (SourceRead);
...
export type ListEmbeddingModelsResponse = (Array<EmbeddingModelRead>);

export type CreateEmbeddingModelData = {
    requestBody: EmbeddingModelCreate;
};

export type CreateEmbeddingModelResponse = (EmbeddingModelRead);

export type GetAvailableModelsResponse = (unknown);

export type CheckEmbeddingProviderHealthResponse = (unknown);

export type GetEmbeddingModelStatsData = {
    modelId: number;
};

export type GetEmbeddingModelStatsResponse = (EmbeddingStatsResponse);

export type GenerateEmbeddingsData = {
    requestBody: EmbeddingGenerateRequest;
};

export type GenerateEmbeddingsResponse = (unknown);

export type SimilaritySearchData = {
    requestBody: EmbeddingSearchRequest;
};

export type SimilaritySearchResponse = (EmbeddingSearchResponse);

export type EmbedTextData = {
    modelName: string;
    provider: EmbeddingProvider;
    text: string;
};

export type EmbedTextResponse = (unknown);
...
export type TestEmbeddingProviderResponse = (unknown);

export type DeactivateEmbeddingModelData = {
    modelId: number;
};

export type DeactivateEmbeddingModelResponse = (unknown);
