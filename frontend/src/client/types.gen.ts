...
export type GraphAssistRequest = {
    prose: string;
};

export type GraphAssistResponse = {
    q: string;
};
...
export type Projection = {
    ...
    label?: (string | null);
    about?: (string | null);
    role?: ('vector' | 'step' | 'anchor' | 'body' | 'companion' | 'edge' | 'attachment' | null);
    frame?: ('time' | 'geo' | 'interest' | 'event' | null);
    node_kind?: 'occurrence' | 'entity';
    node_type?: (string | null);
    node_type_path?: (string | null);
    node_label?: (string | null);
    node_name?: (string | null);
};

export type node_kind = 'occurrence' | 'entity';
...
export type ListConversationsData = {
    /**
     * Filter by agent persona. Empty/absent → workspace chats only (no agent_kind set). Pass 'any' to skip the filter entirely, which also surfaces threads left by retired personas.
     */
...
export type GraphContextResponse2 = (GraphContextResponse);

export type GraphValidateData = {
    infospaceId: number;
    packageToken?: (string | null);
    requestBody: GraphValidateRequest;
    runId: number;
    xPackageToken?: (string | null);
};

export type GraphValidateResponse2 = (GraphValidateResponse);

export type GraphAssistData = {
    infospaceId: number;
    packageToken?: (string | null);
    requestBody: GraphAssistRequest;
    runId: number;
    xPackageToken?: (string | null);
};

export type GraphAssistResponse2 = (GraphAssistResponse);
