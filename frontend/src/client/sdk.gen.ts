...
export class CanonicalEntitiesService {
    ...
    public static mergeEntities(data: MergeEntitiesData): CancelablePromise<MergeEntitiesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/infospaces/{infospace_id}/entities/merge',
            path: {
                infospace_id: data.infospaceId
            },
            headers: {
    ...
    public static triggerResolution(data: TriggerResolutionData): CancelablePromise<TriggerResolutionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/infospaces/{infospace_id}/entities/resolve',
            path: {
                infospace_id: data.infospaceId
            },
            headers: {
...
export class ProvidersService {
     ...
     * @param data The data for the request.
     * @param data.capability Capability type: 'llm', 'embedding'
     * @returns unknown Successful Response
     * @throws ApiError
     */
...
export class QueryService {
     ...
     *
     * JSON by default (pagination always JSON). SSE (Accept: text/event-stream)
     * delivers results fast, then streams count and children later.
     * @param data The data for the request.
     * @param data.infospaceId
     * @param data.requestBody
     * @param data.packageToken
     ...
     * @throws ApiError
     */
    public static queryAssets(data: QueryAssetsData): CancelablePromise<QueryAssetsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getQueryFields(data: GetQueryFieldsData): CancelablePromise<GetQueryFieldsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class TreeNavigationService {
     ...
     *
     * JSON by default. SSE (Accept: text/event-stream) delivers tree nodes
     * fast, then streams total counts later.
     * @param data The data for the request.
     * @param data.infospaceId
     * @param data.packageToken
     * @param data.xPackageToken
     ...
     *
     * JSON by default. SSE (Accept: text/event-stream) delivers assets fast,
     * then streams count later.
     * @param data The data for the request.
     * @param data.infospaceId
     * @param data.skip
     * @param data.limit
     ...
     * @param data.bundleId Filter to assets in this bundle (for Bundle detail)
     * @param data.pathFilter Filter by logical_path prefix (for virtual folder)
     * @param data.packageToken
     * @param data.xPackageToken
     ...
     * @param data.assetKinds Filter by asset types
     * @param data.bundleId Search within specific bundle
     * @param data.packageToken
     * @param data.xPackageToken
     * @returns TextSearchResponse Successful Response
     * @throws ApiError
     */
    public static textSearchAssets(data: TextSearchAssetsData): CancelablePromise<TextSearchAssetsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infospaces/{infospace_id}/tree/text-search',
            path: {
                infospace_id: data.infospaceId
            },
            headers: {
