...
export const GQL_PREFIXES = [
  { prefix: 'type:', hint: 'Node entity type', tier: 2 },
  { prefix: 'kind:', hint: 'occurrence (happened) vs entity (persists)', tier: 2 },
  { prefix: 'serves:', hint: 'Serves this interest; + rolls up the hierarchy', tier: 2 },
  { prefix: 'role:', hint: 'Projection role the node appeared in', tier: 2 },
  { prefix: 'predicate:', hint: 'Edge predicate', tier: 1 },
  { prefix: 'field:', hint: 'Restrict to one projection', tier: 1 },
  { prefix: 'after:', hint: 'Still alive at/after (ISO date)', tier: 2 },
  { prefix: 'before:', hint: 'Began at/before (ISO date)', tier: 2 },
  { prefix: 'from:', hint: 'Traversal seed node', tier: 3 },
  { prefix: 'hops:', hint: 'Traversal depth (default 1, max 10)', tier: 3 },
  { prefix: 'near:', hint: 'Within a radius, e.g. near:"Berlin"<200km', tier: 2 },
] as const;
...
export const GQL_EXAMPLES = [
  ...
  { q: 'serves:opacity+ converge>0.6', desc: 'Aligned on an interest, with nothing connecting them' },
...
const SHAPE_KEYS = new Set(['degree', 'weight', 'mentions', 'frequency', 'converge']);
